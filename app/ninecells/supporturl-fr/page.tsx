...
const screenshots = [
  "/work/ninecells/fr/01-device-bottom.jpg",
  "/work/ninecells/fr/02-device-bottom.jpg",
  "/work/ninecells/fr/03-device-bottom.jpg",
  "/work/ninecells/fr/04-device-bottom.jpg",
];

export default function NineCellsSupportFR() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-neutral-400">
            Sudoku moderne — Typographie épurée, rythme apaisé, app watchOS et Live Activities.
          </p>
        </div>
        ...
        <div className="mb-12 grid grid-cols-2 gap-4 md:grid-cols-4">
          {screenshots.map((src, i) => (
            <div key={i} className="overflow-hidden rounded-xl">
              <Image
                src={src}
                alt={`Capture d'écran NineCells ${i + 1}`}
                width={320}
                height={693}
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          <h2 className="mb-2 text-xl font-light">Support & Contact</h2>
          <p className="mb-4 text-neutral-400">
            Pour toute question, suggestion ou rapport de bug, contactez-nous.
          </p>
          <a
