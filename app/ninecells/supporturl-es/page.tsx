...
const screenshots = [
  "/work/ninecells/es/01-device-bottom.jpg",
  "/work/ninecells/es/02-device-bottom.jpg",
  "/work/ninecells/es/03-device-bottom.jpg",
  "/work/ninecells/es/04-device-bottom.jpg",
];

export default function NineCellsSupportES() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          ...
          <p className="mb-4 text-neutral-400">
            Para preguntas, sugerencias o reportes de errores, contáctanos.
          </p>
          <a
