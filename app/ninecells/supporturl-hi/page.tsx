...
const screenshots = [
  "/work/ninecells/hi/01-device-bottom.jpg",
  "/work/ninecells/hi/02-device-bottom.jpg",
  "/work/ninecells/hi/03-device-bottom.jpg",
  "/work/ninecells/hi/04-device-bottom.jpg",
];

export default function NineCellsSupportHI() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-neutral-400">
            मॉडर्न सुडोकू — साफ़ टाइपोग्राफ़ी, शांत रफ़्तार, watchOS साथी और Live Activities।
          </p>
        </div>
        ...
        <div className="mb-12 grid grid-cols-2 gap-4 md:grid-cols-4">
          {screenshots.map((src, i) => (
            <div key={i} className="overflow-hidden rounded-xl">
              <Image
                src={src}
                alt={`NineCells का स्क्रीनशॉट ${i + 1}`}
                width={320}
                height={693}
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          <h2 className="mb-2 text-xl font-light">सपोर्ट और संपर्क</h2>
          <p className="mb-4 text-neutral-400">
            सवाल, सुझाव या बग रिपोर्ट के लिए हमसे संपर्क करें।
          </p>
          <a
