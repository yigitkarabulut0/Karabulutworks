...
const screenshots = [
  "/work/ninecells/it/01-device-bottom.jpg",
  "/work/ninecells/it/02-device-bottom.jpg",
  "/work/ninecells/it/03-device-bottom.jpg",
  "/work/ninecells/it/04-device-bottom.jpg",
];

export default function NineCellsSupportIT() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-neutral-400">
            Sudoku moderno — Tipografia pulita, ritmo calmo, app watchOS e Live Activity.
          </p>
        </div>
        ...
        <div className="mb-12 grid grid-cols-2 gap-4 md:grid-cols-4">
          {screenshots.map((src, i) => (
            <div key={i} className="overflow-hidden rounded-xl">
              <Image
                src={src}
                alt={`Screenshot di NineCells ${i + 1}`}
                width={320}
                height={693}
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          <h2 className="mb-2 text-xl font-light">Supporto e contatti</h2>
          <p className="mb-4 text-neutral-400">
            Per domande, suggerimenti o segnalazioni di bug, contattaci.
          </p>
          <a
