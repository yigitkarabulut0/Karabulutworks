...
const screenshots = [
  "/work/ninecells/ru/01-device-bottom.jpg",
  "/work/ninecells/ru/02-device-bottom.jpg",
  "/work/ninecells/ru/03-device-bottom.jpg",
  "/work/ninecells/ru/04-device-bottom.jpg",
];

export default function NineCellsSupportRU() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-neutral-400">
            Современное судоку — чистая типографика, спокойный темп, поддержка watchOS и Live Activities.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          <h2 className="mb-2 text-xl font-light">Поддержка и контакты</h2>
          <p className="mb-4 text-neutral-400">
            По вопросам, предложениям или сообщениям об ошибках напишите нам.
          </p>
          <a
