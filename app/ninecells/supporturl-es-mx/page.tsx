...
const screenshots = [
  "/work/ninecells/es-mx/01-device-bottom.jpg",
  "/work/ninecells/es-mx/02-device-bottom.jpg",
  "/work/ninecells/es-mx/03-device-bottom.jpg",
  "/work/ninecells/es-mx/04-device-bottom.jpg",
];

export default function NineCellsSupportESMX() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-neutral-400">
            Sudoku moderno — Tipografía limpia, ritmo tranquilo, app para watchOS y Live Activities.
          </p>
        </div>
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          <h2 className="mb-2 text-xl font-light">Soporte y contacto</h2>
          <p className="mb-4 text-neutral-400">
            Para preguntas, sugerencias o reportes de errores, escríbenos.
          </p>
          <a
