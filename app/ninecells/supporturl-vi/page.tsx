...
const screenshots = [
  "/work/ninecells/vi/01-device-bottom.jpg",
  "/work/ninecells/vi/02-device-bottom.jpg",
  "/work/ninecells/vi/03-device-bottom.jpg",
  "/work/ninecells/vi/04-device-bottom.jpg",
];

export default function NineCellsSupportVI() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-neutral-400">
            Sudoku hiện đại — Sắp chữ gọn gàng, nhịp độ thư thái, ứng dụng watchOS và Live Activities.
          </p>
        </div>
        ...
        <div className="mb-12 grid grid-cols-2 gap-4 md:grid-cols-4">
          {screenshots.map((src, i) => (
            <div key={i} className="overflow-hidden rounded-xl">
              <Image
                src={src}
                alt={`Ảnh chụp màn hình NineCells ${i + 1}`}
                width={320}
                height={693}
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          <h2 className="mb-2 text-xl font-light">Hỗ trợ & Liên hệ</h2>
          <p className="mb-4 text-neutral-400">
            Mọi câu hỏi, góp ý hay báo lỗi, vui lòng liên hệ với chúng tôi.
          </p>
          <a
