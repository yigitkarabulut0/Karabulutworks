...
const screenshots = [
  "/work/ninecells/zh/01-device-bottom.jpg",
  "/work/ninecells/zh/02-device-bottom.jpg",
  "/work/ninecells/zh/03-device-bottom.jpg",
  "/work/ninecells/zh/04-device-bottom.jpg",
];

export default function NineCellsSupportZH() {
  return (
      ...
      <div className="mx-auto max-w-4xl px-6 py-16">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="text-lg text-neutral-400">
            现代数独 — 简洁排版、舒缓节奏,支持 watchOS 与实时活动。
          </p>
        </div>
        ...
        <div className="rounded-xl border border-neutral-800 bg-neutral-900/50 p-8 text-center">
          <h2 className="mb-2 text-xl font-light">支持与联系</h2>
